...
四書五經共 366 則，涵蓋《論語》111 則、《孟子》70 則、《大學》20 則、《中庸》30 則、《禮記》其他篇章 40 則、《周易》41 則、《尚書》25 則、《詩經》19 則、《春秋左氏傳》10 則；《左傳》明確標示為傳文。兩個分類皆交錯安排來源，在資料內容與順序不變時，連續 366 天不重複，第 367 天開始下一輪，跨年不重設。電子版本資訊見[經典來源說明](docs/quote-sources/README.md)。

文學短句收錄 366 則。文學短句以成長與省思為選句方向，收錄現代散文、小說及《菜根譚》《圍爐夜話》《幽夢影》等哲理小品，附作者、篇名、原文及來源網址。支援五種版型、偏好保存與公共資料更新；資料及順序不變時，連續 366 天不重複，第 367 天開始下一輪。詳細版本與整理方式見[來源說明](docs/quote-sources/README.md)。
...
「影視佳句」共 366 則，包含電影與動畫電影 307 則、電視與動畫影集 59 則，以希望、自我認識、挫折、關係與人生選擇為主題。保留原有 33 則，新增 333 則；每則附作品中英文名、年份、所據英文台詞及來源，中文為專案自譯，並非官方字幕。非英語原作另標明採用英文譯本／配音版本。依台灣日期每日輪替，在資料與順序不變時連續 366 天不重複，第 367 天開始下一輪，跨年不重設。新增來源與查核方式見 [擴充紀錄](docs/quote-sources/screen-expansion.md)，原有清單見 [先前來源整理](docs/quote-sources/screen-review.md)。
