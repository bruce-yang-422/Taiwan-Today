...
- 時光讀本：深藍日期側欄、每日一句、歷史時間軸，底部提供搜尋與捷徑。每日一句可在設定選擇「每日提醒、佛家智慧、負能量（幽默）、四書五經、名人語錄」，於五種樣式皆可顯示；分類自動保存，依台灣日期在所選分類內輪替。
